...
const LearningScreen = () => {
  ...
  const [activePanel, setActivePanel] = useState(null); // 'topics' | 'chat' | null
        ...
        <View style={[styles.iconRail, {
          ...
          >
            <MaterialIcon
              ...
              size={22}
              color={activePanel === 'topics' ? theme.colors.primary : 'rgba(255,255,255,0.45)'}
            />
            <Text style={[styles.railLabel, { color: activePanel === 'topics' ? theme.colors.primary : 'rgba(255,255,255,0.35)' }]}>
              Topics
            </Text>
          </TouchableOpacity>
          ...
          >
            <Icon
              ...
              size={22}
              color={activePanel === 'chat' ? theme.colors.primary : 'rgba(255,255,255,0.45)'}
            />
            <Text style={[styles.railLabel, { color: activePanel === 'chat' ? theme.colors.primary : 'rgba(255,255,255,0.35)' }]}>
              Chat
            </Text>
          </TouchableOpacity>
        </View>
